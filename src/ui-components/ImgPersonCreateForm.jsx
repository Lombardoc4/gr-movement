...
export default function ImgPersonCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setImage_id(initialValues.image_id);
    setForever_age(initialValues.forever_age);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ImgPerson(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ImgPersonCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
